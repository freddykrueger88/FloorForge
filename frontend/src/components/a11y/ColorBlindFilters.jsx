 ...
 * `filter: url(#floorforge-cb-...)` auf documentElement angewendet werden
...
export default function ColorBlindFilters() {
  return (
    <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
      <defs>
        <filter id="floorforge-cb-protanopie">
        ...
        <filter id="floorforge-cb-deuteranopie">
          <feColorMatrix type="matrix" values="
            0.625 0.375 0   0 0
            0.7   0.3   0   0 0
            0     0.3   0.7 0 0
        ...
        <filter id="floorforge-cb-tritanopie">
          <feColorMatrix type="matrix" values="
            0.95 0.05  0     0 0
            0    0.433 0.567 0 0
            0    0.475 0.525 0 0
        ...
        <filter id="floorforge-cb-monochromie">
